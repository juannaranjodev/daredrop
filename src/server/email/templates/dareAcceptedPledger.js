	...
	const mailContent = `
            <table border="0" cellpadding="0" cellspacing="0" style="margin-top:0;margin-bottom:0;margin-left:auto;margin-right:auto;padding:0;color:#354052;font-family:Roboto,sans-serif;font-size:26px;line-height:1.25;" width="480" class="content">
              <tbody>
                ...
                <tr>
                  <td style="margin:0;padding:0;" width="100%">
                    <p style="margin:0;padding:0;">${streamer} has accepted your Dare to ${dareTitle}!</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="margin:0; padding:0;" width="100%">
                    <p style="margin:0;padding:0;">${streamer} said they’d deliver if our bounty hits ${goal}. Can we get there in the ${expiryCalculator(expiryTime)} left?</p>
                  </td>
                </tr>
