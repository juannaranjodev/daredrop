...
import {
	API_LAMBDA_EXECUTION_ROLE, API_DYNAMO_DB_TABLE, API_DYNAMO_DB_ARCHIVAL_TABLE,
	PERFORMANCE_TEST_DYNAMODB_DATA_TABLE, PERFORMANCE_TEST_ARCHIVAL_DYNAMODB_DATA_TABLE,
...
export const Environment = {
	Variables: {
		...
		API_DYNAMO_DB_ARCHIVAL_TABLE: ref(API_DYNAMO_DB_ARCHIVAL_TABLE),
		...
		PERFORMANCE_TEST_DYNAMODB_ARCHIVAL_TABLE: process.env.STAGE !== 'production' ? ref(PERFORMANCE_TEST_ARCHIVAL_DYNAMODB_DATA_TABLE) : undefined,
	},
}
