...
export const API_DYNAMO_ARCHIVAL_TABLE_NAME = 'apiDynamoArchivalTableName'
export const PERFORMANCE_TEST_DYNAMODB_DATA_TABLE_ARN = 'performanceTestDynamoDBDataTableArn'
export const PERFORMANCE_TEST_ARCHIVAL_DYNAMODB_DATA_TABLE_ARN = 'performanceTestArchivalDynamoDBDataTableArn'
