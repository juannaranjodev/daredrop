import { GET_PENDING_PROJECTS, GET_PLEDGED_PROJECTS } from 'root/src/shared/descriptions/endpoints/endpointIds'
...
export default {
	[PENDING_PROJECTS_LIST_MODULE_ID]: {
		...
		endpointId: [GET_PENDING_PROJECTS, GET_PLEDGED_PROJECTS],
