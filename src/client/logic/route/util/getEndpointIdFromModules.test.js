...
test('returns correct endpointId from module', () => {
	...
	expect(getEndpointIdFromModules(PENDING_PROJECTS_LIST_MODULE_ID)).toEqual([GET_PENDING_PROJECTS, GET_PLEDGED_PROJECTS])
	expect(getEndpointIdFromModules(ACTIVE_PROJECTS_LIST_MODULE_ID)).toEqual([GET_ACTIVE_PROJECTS, GET_PLEDGED_PROJECTS])
	expect(getEndpointIdFromModules(FAVORITES_PROJECTS_LIST_MODULE_ID)).toEqual([GET_FAVORITES_LIST, GET_PLEDGED_PROJECTS])
	expect(getEndpointIdFromModules(MY_PROJECTS_LIST_MODULE_ID)).toEqual([GET_MY_PROJECTS, GET_PLEDGED_PROJECTS])
})
